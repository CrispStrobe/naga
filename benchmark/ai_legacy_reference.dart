...
import 'dart:math';
// Frozen pre-optimization reference; only imports, class name and RNG injection
// differ from the original implementation. Do not apply production fixes here.
...
class LegacySnakeAI {
  ...
  LegacySnakeAI({required this.difficulty, Random? random})
  ...
  Direction _decideEasy(
    ...
    if (_random.nextDouble() < 0.30) {
      final candidates = Direction.values
          .where((d) => !_isOpposite(d, cur))
          .toList();
